...
const ProductDetail = () => {
  ...
  // 🖼️ Image control
  const currentImageUrl = product?.images?.[currentImage]?.url || product?.mainImage
  const isAlreadyLoaded = loadedImages.has(currentImageUrl)
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} className="space-y-4">
            <div className="relative aspect-square rounded-2xl overflow-hidden bg-gray-100">
                ...
                <motion.img
                  ...
                  onLoad={() =>
                    setLoadedImages(prev => {
                      ...
                      updated.add(currentImageUrl)
                      return updated
                    })
                  }
                  initial={!isAlreadyLoaded ? { opacity: 0 } : { opacity: 1 }}
                  animate={{ opacity: 1 }}
                  exit={{ opacity: 0 }}
                  transition={{
                    duration: isAlreadyLoaded ? 0.2 : 0.5,
                    ease: 'easeInOut',
                  }}
              ...
              {/* ✨ Shimmer only if not loaded before */}
              {!isAlreadyLoaded && (
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-teal-50 to-cyan-50 rounded-2xl p-6">
              <p className="text-gray-700 text-center">
                <strong>Note:</strong> Currently, we do not offer online delivery. Please add items to your wishlist
                and visit our store.
              </p>
            </div>
          </motion.div>
...
//     return (
//       <div className="min-h-screen flex items-center justify-center">
//         <p className="text-xl text-gray-500 animate-pulse"><Loader/></p>
//       </div>
//     )
